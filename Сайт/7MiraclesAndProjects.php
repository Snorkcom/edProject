...
<head>
    ...
    <TITLE>Чудеса и проекты | CIVILOPEDIA VI</TITLE>
    ...
    <div class="topContainer" style="z-index: 2;  position: relative;">
        ...
        <div class="tabrow">
           ...
           <a href="4CityStates.php">                          <img src="./StartPage_files/images/tabrow/04.1.png" class="tab" 				title="Города-государства">            </a>
            ...
            <a href="7MiraclesAndProjects.php">                 <img src="./StartPage_files/images/tabrow/07.2.png" class="tab"	id="now"	title="Чудеса и проекты">            </a>

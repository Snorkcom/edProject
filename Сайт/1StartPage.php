...
<head>
    ...
    <TITLE>Понятия | CIVILOPEDIA VI</TITLE>
    ...
    <script> var table = "concepts"; </script>
...
<body>
    <div class="CenterDiv">
        ...
        <div class="topContainer" style="z-index: 2;  position: relative;">
            ...
            <div class="tabrow">
                <a href="1StartPage.php">                           <img src="./StartPage_files/images/tabrow/01.2.png" class="tab" id="now" title="Понятия">  </a>
        ...
        <div class="content">
            ...
            <div class="menu" class="mCustomScrollbarMy" data-mcs-theme="inset-2">
                ...
                <div class="menugroupcontainer">
                    ...
                    <a href="1StartPage.php"><div class="menuitem">Начало игры</div></a>
                                            ...
                                            <div class="lt">
                                                <div class="rt">
                                                    ...
                                                    <div id="contentFromDB">
                                                        ...
                                                        $product = select('introduction','Понятия');

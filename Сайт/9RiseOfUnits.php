...
<head>
    ...
    <TITLE>Повышение юнитов | CIVILOPEDIA VI</TITLE>
...
<body>
    ...
    <div class="topContainer" style="z-index: 2;  position: relative;">
        ...
        <div class="tabrow">
            ...
            <a href="9RiseOfUnits.php">                         <img src="./StartPage_files/images/tabrow/09.2.png" class="tab"	id="now"	title="Повышение юнитов">            </a>

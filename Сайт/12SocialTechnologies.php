...
<head>
    ...
    <TITLE>Социальные институты | CIVILOPEDIA VI</TITLE>
    ...
    <div class="topContainer" style="z-index: 2;  position: relative;">
        ...
        <div class="tabrow">
           ...
           <a href="4CityStates.php">                          <img src="./StartPage_files/images/tabrow/04.1.png" class="tab" 				title="Города-государства">            </a>
            ...
            <a href="12SocialTechnologies.php">                  <img src="./StartPage_files/images/tabrow/12.2.png" class="tab"	id="now"	title="Социальные институты">            </a>

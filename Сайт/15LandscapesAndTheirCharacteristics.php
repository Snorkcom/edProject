...
<head>
    ...
    <TITLE>Ландшафты и их характеристика | CIVILOPEDIA VI</TITLE>
    ...
    <div class="topContainer" style="z-index: 2;  position: relative;">
        ...
        <div class="tabrow">
           ...
           <a href="4CityStates.php">                          <img src="./StartPage_files/images/tabrow/04.1.png" class="tab" 				title="Города-государства">            </a>
            ...
            <a href="15LandscapesAndTheirCharacteristics.php">   <img src="./StartPage_files/images/tabrow/15.2.png" class="tab"	id="now"	title="Ландшафты и их характеристики">            </a>
   ...
   <div class="content">
        ...
        <div class="menu" class="mCustomScrollbarMy" data-mcs-theme="inset-2">
            ...
            <div class="menugroupcontainer">
				 ...
				 <div class="menuitem">Начало игры</div>
				<div class="menugroup">Города</div>
					<div class="panel" style="display: block;">				
						 <div class="menuitem">Введение</div>	
						 <div class="menuitem">Как строить города</div>
						 <div class="menuitem">Рост</div>	
						 <div class="menuitem">Пища</div>		
					</div>
				<div class="menugroup">Мир</div>
					<div class="panel" style="display: block;">				
						 <div class="menuitem">Ландшафт</div>	
						 <div class="menuitem">Ресурсы</div>	
						 <div class="menuitem">Чудеса природы</div>
						 <div class="menuitem">Реки</div>		
					</div>		
				<div class="menugroup">Сражения</div>
					<div class="panel" style="display: block;">				
						 <div class="menuitem">Введения</div>	
						 <div class="menuitem">Объявление войны</div>	
						 <div class="menuitem">Усталость от войн</div>	
						 <div class="menuitem">Милитаризм</div>		
					</div>		
				<div class="menugroup">Движение юнитов</div>
					<div class="panel" style="display: block;">				
						 <div class="menuitem">Очки перемещения</div>	
						 <div class="menuitem">Дороги</div>
						 <div class="menuitem">Зона контроля</div>	
						 <div class="menuitem">Передвижение кораблей</div>		
					</div>	
                            ...
                            <div class="b">
                                <div class="lb">
                                    <div class="rb">
                                        <div class="lt">
                                            <div class="rt">
                                                <div class="contentHeader"> <br> Header </div>
                                                <br>												
														...
														<td id="l_td" width="380">
															<div class="contentSubheader"> Subheader </div>
															<p style="margin-top:4px;">
															Женьшень — оказывает благотворное влияние на нервную систему, что улучшает настроение. Регулярное его использование влияет на рост адреналина и серотонина в мозге, улучшает концентрацию и способствует обучению. Имеет способность нейтрализовать свободные радикалы, преждевременное старение, и используется также для производства многих косметических средств. Корень женьшеня рекомендуются в первую очередь для пожилых людей, потому что он дополнительно улучшает память и задерживает старение. Подготовить чай просто. Столовую ложку сырья должны залить кипятком и держать нескольких минут. После охлаждения настой можно пить. Корни также можно жевать, как жвачку. Женьшень может увеличить или уменьшить давление, в зависимости от дозы, может привести к сердечной аритмии, бессоннице, и даже аллергии.
															</p> <br>
														...
														<td id="r_td">
															<img src="./StartPage_files/images/content/1.png" alt="альтернативный текст">														
														</td>
														</tr>
														</table>

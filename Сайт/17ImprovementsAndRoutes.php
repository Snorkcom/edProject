...
<head>
    ...
    <TITLE>Улучшения и маршруты | CIVILOPEDIA VI</TITLE>
    ...
    <div class="topContainer" style="z-index: 2;  position: relative;">
        ...
        <div class="header"><a href="" class="titlelink">CIVILOPEDIA VI</a></div>
         ...
         <div class="tabrow">
            ...
            <a href="17ImprovementsAndRoutes.php">               <img src="./StartPage_files/images/tabrow/17.2.png" class="tab"	id="now"	title="Улучшения и маршруты">            </a>
        </div>
    </div>
